        ...
        <div className="container mx-auto px-4 md:px-32 ">
          ...
          <div className="mb-8">
            ...
            <p className="text-[16px] text-gray-700">
              This privacy policy sets out how <span className="font-bold">mutual</span>fundsadda{" "}
              uses and protects any information that you share when you use this
              website. <span className="font-bold">mutual</span>fundsadda is committed to ensuring
              ...
              <span className="font-bold">mutual</span>fundsadda may change this
              policy from time to time by updating this page. This policy is
              effective from June 1, 2018.
              <span className="font-bold">mutual</span>fundsadda understands
              that our relationship is strongly built on trust and faith. In
              Course of using information on this website or availing the
              services, <span className="font-bold">mutual</span>fundsadda may become privy to the
              personal information of its customer including information that is
              of confidential nature. <span className="font-bold">mutual</span>fundsadda is strictly
              ...
              <span className="font-bold">mutual</span>fundsadda, in any way or manner.{" "}
              <span className="font-bold">mutual</span>fundsadda is not responsible for the setup of
              any hyperlink from a third party website to{" "}
              <span className="font-bold">mutual</span>fundsadda
            </p>
          </div>
