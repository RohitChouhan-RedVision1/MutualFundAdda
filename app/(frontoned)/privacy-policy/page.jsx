...
//     console.log(sitedata.websiteName,"dnjsjnhs")
//     return (
//       <div>
//         <div>
...
//               This privacy policy sets out how <b>{sitedata.websiteName}</b>  uses and protects any information that you share when you use this website. <b>{sitedata.websiteName}</b> is committed to ensuring that your privacy is protected at all times. Should we ask you to provide certain information by which you can be identified when using this website, you can be assured that it will only be used in accordance with this privacy statement.

// <b>{sitedata.websiteName}</b> may change this policy from time to time by updating this page. This policy is effective from June 1, 2018.

// <b>{sitedata.websiteName}</b> understands that our relationship is strongly built on trust and faith. In Course of using information on this website or availing the services, <b>{sitedata.websiteName}</b> may become privy to the personal information of its customer including information that is of confidential nature. <b>{sitedata.websiteName}</b> is strictly committed to protecting the privacy of its Customer and has taken reasonable measures to protect the confidentiality of the customer information and its transmission through World Wide Web. However it shall not be liable in any manner for disclosure of the confidential information in accordance with this Privacy Commitment or in terms of the agreement if any with the Customer or by reasons beyond its control. We may however be required to disclose your personal information to Government, Judicial bodies, and our Regulators or to any person to whom the Firm is under an obligation to make disclosure under the requirements of any law binding on the Firm or any of its branches, if required. Hyperlink Policy for user Any hyperlink to other Internet sites is at customers own risk. The contents of which and the accuracy of opinions expressed are not verified, monitored or endorsed by <b>{sitedata.websiteName}</b>, in any way or manner. <b>{sitedata.websiteName}</b> is not responsible for the setup of any hyperlink from a third party website to <b>{sitedata.websiteName}.</b>
//               </p>
//             </div>
...
//               </h2>
//               <p className="text-xl text-gray-700">
//               If you believe that any of your information with us is incorrect or incomplete, please email us as soon as possible at <span className="text-[var(--primary)]">{sitedata.email}</span> We will promptly correct any information found to be incorrect.
//               </p>
//             </div>
