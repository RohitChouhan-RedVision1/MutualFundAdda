      ...
      <div className="container mx-auto px-4 md:px-20">
        ...
        <div className="mb-5">
          ...
          <ul className="list-disc pl-5 space-y-4">
            ...
            <li>
              ...
              <p className="text-gray-700">
                Invest in bonds and other fixed-income securities. These are
                less risky than equity funds, making them ideal for conservative
                investors.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p className="text-gray-700">
                ...
                Sensex, providing a passive investment strategy with lower
                costs.
              </p>
            </li>
            <li>
              ...
              <p className="text-gray-700">
                Invest in short-term money market instruments like treasury
                bills and commercial papers. Suitable for investors looking for
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-4">
            ...
            <li>
              <p className="text-gray-700">
                Professional Management: Your investment is managed by expert
                fund managers who make decisions based on market conditions.
              </p>
            </li>
            <li>
              <p className="text-gray-700">
            ...
            <li>
              <p className="text-gray-700">
                ...
                mutual funds, making them accessible to a wide range of
                investors.
              </p>
            </li>
            <li>
