                    ...
                    <CarouselContent className="flex -ml-0">
                        {data.map((item, index) => (
                            <div key={index} className="md:basis-1/6 lg:basis-1/6">
                                <div
                                    className="px-3  flex items-center gap-2 thirdbgcolor border-r border-white w-72"
                                >
                                  ...
                                  <div className='flex items-center gap-2 bg-gray-600  p-2 w-48 border rounded-md'>
                                  <span
